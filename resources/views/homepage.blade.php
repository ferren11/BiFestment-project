        ...
        <div class="p-0 ms-4" style="width: 20%">
            ...
            <div class="card">
                ...
                <div class="row position-absolut start-10">
                    ...
                    <img src="{{ $upcomingevent -> event_image }}" class="card-img-top mb-1 mx-1" style="width: 72%" alt="{{ $upcomingevent -> event_image }}">
                </div>
                <h6 class="px-3 pb-1 pt-2 m-0 fs-5">{{ $upcomingevent->event_name }}</h6>
                <p class="px-3 pt-0 pb-3 m-0" style="font-size: small;">{{ $upcomingevent->event_time }}</p>
            </div>
                    ...
                    <div class="row">
                        @foreach ($events as $event)
                            @if ($event->category_id == $category->id)
                                <a href="{{ route('details', ['eventId' => $event->id]) }}">
